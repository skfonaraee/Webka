// js/ongoing.js - Handle ongoing dramas page

document.addEventListener('DOMContentLoaded', function() {
    // Reset global selectedGenres when entering ongoing page
    selectedGenres = [];
    
    // Filter dramas with "Ongoing" status
    const ongoingDramas = dramas.filter(d => d.status === 'Ongoing');
    
    // Initialize page with ongoing dramas only
    renderDramaGrid(ongoingDramas);
    ...
    // Store the ongoing dramas globally for filtering
    window.allDramas = ongoingDramas;
    window.filteredDramas = ongoingDramas;
});

// Render drama cards in grid (same as main.js)
